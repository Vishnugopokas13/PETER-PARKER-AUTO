...
BOT_TOKEN = environ.get('BOT_TOKEN', '6018095007:AAGyqzN8_07omGbxMNxYTc5PMhjfkUVFx9Y')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://V:V@cluster0.xx2u1eq.mongodb.net/?retryWrites=true&w=majority")
...
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '-1001905405868"').split()]
...
S_GROUP = environ.get('S_GROUP',"https://t.me/wmteams")
MAIN_CHANNEL = environ.get('MAIN_CHANNEL',"https://t.me/wmteams")
FILE_FORWARD = environ.get('FILE_FORWARD',"https://t.me/wmteams")
