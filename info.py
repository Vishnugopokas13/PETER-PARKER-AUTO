...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://V:V@cluster0.ofbn0aj.mongodb.net/?retryWrites=true&w=majority")
...
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '-1001943096607').split()]
...
REQ_CHANNEL = environ.get("REQ_CHANNEL", "-1001858954978")
